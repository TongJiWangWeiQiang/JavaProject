...
<body style="background-color: #f2f9fd">
    <div class="header bg-main">
        <div class="logo margin-big-left fadein-top color-bar">
            <h1>管理员后台</h1>
        </div>
        <div class="head-l">
            <a class="button button-little bg-green" href="${ctx}/admin/login.jsp" target="_blank">
                <span class="icon-home"></span>前台首页
            </a>
            <a class="button button-little bg-red" href="${ctx}/admin/mexit.action">
    ...
    <div class="leftnav">
        ...
        <ul style="display: block">
            <li><a href="${ctx}/shoppingCategory/findCategory.action" target="right"><span class="icon-caret-right"></span>类别管理</a> </li>
